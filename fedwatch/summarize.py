...
SUMMARY_STYLES = {
    "Executive summary": (
        ...
        "high-priority items with 🟠, and starting each bullet with the bold word **New:** "
        "(first coverage of new matter, per its NEW marker) or **Ongoing:** (a development "
        "in a matter already being tracked, per its ONGOING marker), then the **bolded "
        "short name** - what happened and the so-what for "
