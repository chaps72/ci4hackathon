...
def custom_report(question: str, facts_md: str, prior: str = "") -> tuple[str, str]:
    ...
    prompt = (
        ...
        "PRIORITIZE GRAPHS over long lists/tables: the app renders a bar chart "
        "alongside your answer for any breakdown, comparison, ranking, or trend. "
        "So give a concise narrative with the key figures and let the graph carry "
        "the detail — do NOT reproduce a long table or a long bulleted list of "
        "every category; summarize the top few and note the rest is in the chart. "
